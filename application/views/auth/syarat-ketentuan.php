                    ...
                    <div class="col-11">
                        <div class="card custome__card__content mt-5 mb-5">
                            <div class="card-body pt-4 pb-4 faq__content">
                                <h6 class="text-center mb-4">Syarat dan ketentuan</h6>
                                <p class="text-justify">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sit velit ultricies
                                    volutpat id nibh ligula et enim. Facilisis nisi, dolor vitae at lacinia gravida
                                    mauris at. Adipiscing eget augue scelerisque cursus lacus, eget. Vivamus aliquet
                                    dolor vel rhoncus dui augue tellus enim.
                                </p>
                                <p class="text-justify">
                                    Vitae eu libero massa tempus habitant non ut convallis. Faucibus lorem etiam nulla
                                    est nunc magna. Duis ac turpis vitae amet elementum blandit ultricies congue non.
                                    Diam varius non, fermentum semper nullam commodo feugiat aenean enim. Risus, tempor
                                    platea in morbi. Quisque ultrices faucibus congue dolor tellus enim mattis lobortis.
                                    Pulvinar tortor justo sem dui. Gravida adipiscing gravida elementum nullam
                                    fermentum, ultricies at dictum. A rhoncus, amet arcu lobortis enim. In pellentesque
                                    maecenas lacus arcu vitae in tellus id. Elementum ut ac lorem sed feugiat dictum.
                                    Risus elementum amet, tincidunt nec duis ac eget sagittis suspendisse
                                </p>
                            </div>
                        </div>
                    </div>
