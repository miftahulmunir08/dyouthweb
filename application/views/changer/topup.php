        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('changer/Dashboard/topup') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary float-right mr-1">Top Up Kepeng</button>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.name != null) {
                            ...
                            location.href = "https://localhost/nouvacore/event2/Changer/Dashboard/topup?id=" + data.id;
                        }
                    },
                    error: function() {
                        alert("gagal");
