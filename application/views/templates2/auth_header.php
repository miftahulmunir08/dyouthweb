...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets2/'); ?>css/style-screen.css" type="text/css" media="screen">
    <link rel="stylesheet" href="<?= base_url('assets2/'); ?>css/style-print.css" type="text/css" media="print" <link rel="stylesheet" href="style-print.css" type="text/css" media="print">
