...
class Pengaturan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('user/pengaturan/index', $data);
    ...
    public function profile()
    {
        ...
        $this->form_validation->set_rules('born', 'Tanggal', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('templates/notification', $data);
            $this->load->view('templates/sidebar', $data);
            $this->load->view('user/pengaturan/profile', $data);
            $this->load->view('templates/navbottom');
            $this->load->view('templates/footer');
        } else {
    ...
    public function updatephoto()
    {
        if (isset($_POST['image'])) {
            ...
            $url = '././assets/img/profile/';
            $name = time() . '.png';
            $image_name =  $url . $name;

            // if ($result) {
            file_put_contents($image_name, $data);
            echo base_url() . 'assets/img/profile/' . $name;


            $iduser = $this->session->userdata('id');

            $getimage = $this->User->getDataHome($iduser);
            $getimage = $getimage["photo_profile"];
            $path_img = 'assets/img/profile/' . $getimage;
            unlink($path_img);
